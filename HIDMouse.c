...
//Descriptors
const unsigned char deviceDescriptor[] = {0x12, 0x01, 0x10, 0x01, 0x03, 0x01, 0x02, 0x08, 0x3C, 0x41, 0x10, 0x30, 0x00, 0x03, 0x00, 0x00, 0x00, 0x01};
const unsigned char configDescriptor[] = {0x09, 0x02, 0x22, 0x00, 0x01, 0x01, 0x00, 0xA0, 0x00, 0x09, 0x04, 0x01, 0x00, 0x01, 0x03, 0x01, 0x02, 0x00,
                           0x09, 0x21, 0x01, 0x01, 0x00, 0x01, 0x22, 0x32, 0x00, 0x07, 0x05, 0x81, 0x03, 0x08, 0x00, 0x0A};
const unsigned char reportDescriptor[] = {0x05, 0x01, 0x09, 0x02, 0xA1, 0x01, 0x09, 0x01, 0xA1, 0x00, 0x05, 0x09, 0x19, 0x01, 0x29, 0x03, 0x15, 0x00,
				...
				case 0x06:
				{
					switch(wValue >> 8)
					{
						case 0x22:
						{
							...
							int length = (sizeof(reportDescriptor) > wLength)? wLength : sizeof(reportDescriptor);
							USB_StartControlOutput(reportDescriptor, length);
							handled = 1;
							break;
						}
						default:
